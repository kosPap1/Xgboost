...
def variablesCreationCase3(loadTarget, loadLag1, loadLag2, loadLag3, tempTarget, tempLag1, tempLag2, tempLag3 ):
    loadTarget = loadTarget.to_numpy()
    loadLag1 = loadLag1.to_numpy()
    loadLag2 = loadLag2.to_numpy()
    loadLag3 = loadLag3.to_numpy()

    tempTarget = tempTarget.to_numpy()
    tempLag1 = tempLag1.to_numpy()
    tempLag2 = tempLag2.to_numpy()
    tempLag3 = tempLag3.to_numpy()


    return loadTarget, loadLag1, loadLag2, loadLag3, tempTarget, tempLag1, tempLag2, tempLag3
