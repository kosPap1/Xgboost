def holySpirit():
    ...
    from functions.dataInput import load2013, load2014, load2015, load2016, load2017, load2018, load2019, temp2013,temp2014, \
    ...
    loadTrainDayTarget = load2015['2015-06-01']
    loadTrainDayMinus1 = load2015['2015-05-31']
    loadTrainDayMinus7 = load2015['2015-05-25']
    loadTrainDayMinus365 = load2014['2014-06-09']
    loadTrainDayMinus730 = load2013['2013-06-24']

    # Train temperature lag inputs
    temperTrainDayTarget = temp2015['2015-05-01']
    temperTrainDayMinus1 = temp2015['2015-05-31']
    temperTrainDayMinus7 = temp2015['2015-05-25']
    temperTrainDayMinus365 = temp2014['2014-06-09']
    temperTrainDayMinus730 = temp2013['2013-06-24']
